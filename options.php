...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Logo', 'haoui'),
		'id' => 'logo_src',
		'desc' => __('Logo不会做？Easyitlife（Easyitlife）留言求助！Logo 最大高：32px；建议尺寸：140*32px 格式：png', 'haoui'),
	...
	$options[] = array(
		...
		'id' => 'keywords',
		'std' => 'Easyitlife（Easyitlife）,http://Easyitlife,Easyitlife,万事不求人,做最全面的自己',
	...
	$options[] = array(
		...
		'id' => 'description',
		'std' => __('Easyitlife（Easyitlife），万事不求人，做最全面的自己！', 'haoui'),
	...
	$options[] = array(
		...
		'id' => 'footer_seo',
		'std' => '<a href="'.site_url('/sitemap.xml').'">'.__('网站地图', 'haoui').'</a> - 本主题由<a href="http://Easyitlife">Easyitlife（Easyitlife）</a>分享！'."\n",
...
*/
	...
	$options[] = array(
		...
		'id' => 'post_copyright',
		'std' => __('未经Easyitlife（Easyitlife）允许，不得转载本站任何文章：', 'haoui'),
		'type' => 'text');
...
/*
	...
	$options[] = array(
		...
		'desc' => '建议20字内',
		'std' => 'Easyitlife（Easyitlife），万事不求人，做最全面的自己！',
		'type' => 'text');
	...
	$options[] = array(
		'name' => __('微博', 'haoui'),
		'id' => 'weibo',
		'std' => 'http://weibo.com/junzibuqicom',
		'type' => 'text');
